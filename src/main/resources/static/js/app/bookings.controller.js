(function(){
	...
	function BookingsController($http) {
		...
		vm.getAffordableByPrice = getAffordableByPrice;
		init();
		...
		function getAffordableByPrice(price) {
			var url = "/bookings/affordable/" + price;
			var bookingsPromise = $http.get(url);
		...
		function deleteBooking(id){
			...
			var bookingsPromise = $http.post(url).then(function(response){
				vm.bookings = response.data;
			})
		}
